...
\definecolor{darkred}{HTML}{DE0022}
\definecolor{gray}{HTML}{ffffff} %f9f6f2
...
\newcommand{\neutranie}{\tikz[baseline=-0.75ex,blue2]{
    \draw circle (1.2mm);
\node[fill,circle,inner sep=0.3pt] (left eye) at (135:0.5mm) {};
\node[fill,circle,inner sep=0.3pt] (right eye) at (45:0.5mm) {};
\draw (-135:0.9mm) -- (-45:0.9mm);
    }
}

\newcommand{\neutraniered}{\tikz[baseline=-0.75ex,red2]{
    \draw circle (1.2mm);
\node[fill,circle,inner sep=0.3pt] (left eye) at (135:0.5mm) {};
\node[fill,circle,inner sep=0.3pt] (right eye) at (45:0.5mm) {};
\draw (-135:0.9mm) -- (-45:0.9mm);
...
\newcommand{\neutranieblack}{\tikz[baseline=-0.75ex,black]{
    \draw circle (1.2mm);
\node[fill,circle,inner sep=0.3pt] (left eye) at (135:0.5mm) {};
\node[fill,circle,inner sep=0.3pt] (right eye) at (45:0.5mm) {};
\draw (-135:0.9mm) -- (-45:0.9mm);
